...
ActiveRecord::Schema[8.0].define(version: 2025_10_05_165153) do
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.index ["user_id", "label"], name: "index_addresses_on_user_id_and_label_active", unique: true, where: "(deleted_at IS NULL)"
  ...
  create_table "customer_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "default_delivery_address", default: {}
